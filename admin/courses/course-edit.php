...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= url('admin/courses/courses.php') ?>" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-1"></i> Voltar
            </a>
            <?php if ($isEdit): ?>
                <a href="<?= url('admin/modules/modules.php?course_id=' . $course['id']) ?>" class="btn btn-primary">
                    <i class="fas fa-cubes me-1"></i> Módulos
                </a>
                <a href="<?= url('courses/course.php?slug=' . $course['slug']) ?>" target="_blank" class="btn btn-outline-primary">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold"><i class="fas fa-info-circle me-2 text-primary"></i>Informações do Curso</h5>
                    </div>
